...
void *tree_sitter_monkeyc_external_scanner_create() { return NULL; }

void tree_sitter_monkeyc_external_scanner_destroy(void *p) {}

unsigned tree_sitter_monkeyc_external_scanner_serialize(void *payload, char *buffer) { return 0; }

void tree_sitter_monkeyc_external_scanner_deserialize(void *p, const char *b, unsigned n) {}
...
bool tree_sitter_monkeyc_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
